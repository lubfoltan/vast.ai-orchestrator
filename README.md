...
A Python desktop GUI application for automating deep learning model training on [Vast.ai](https://vast.ai) cloud GPUs. Designed for medical imaging classification (chest X-ray) but supports any image classification or tabular regression task.
